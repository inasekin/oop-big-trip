...
/**
 * @extends {Presenter<WaypointListView, AppModel>}
 */
class WaypointListPresenter extends Presenter {
  /**
   * @override
  ...
  /**
   * @param {CustomEvent<HTMLInputElement> & {target: FormView}} event
   */
  ...
  /**
   * @param {CustomEvent & {target: FormView}} event
   */
...
export default WaypointListPresenter;
